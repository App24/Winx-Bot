import { MessageComponentInteraction, ActionRowBuilder, MessageActionRowComponentBuilder, ComponentType, ButtonBuilder, SelectMenuBuilder, ButtonStyle, MessageSelectOption } from "discord.js";
...
export class CustomNameBaseCommand extends BaseCommand{
    public async onRun(cmdArgs: BaseCommandType) {
        ...
        cmdArgs.reply({ content: "generic.selectmenu.placeholder", components: [row] }).then(async (msg) => {
